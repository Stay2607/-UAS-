barangyangdibeli = input("Masukkan barang apa saja yang ingin dibeli(pisahkan dengan koma): ")
...
for x in range(banyakbarang):
    ...
    if int(barangyangdibeli) >= 250000:
        ...
        totaldis += dis
        print(("Harga {}\t Rp. {}\t Diskon Rp. {}").format(list[x], barangyangdibeli, dis))
    elif int(barangyangdibeli) >= 100000 and int(barangyangdibeli) < 250000:
        dis = float(float(barangyangdibeli) * 0.1)
        totaldis += dis
        print(("Harga {} \t Rp. {}\t Diskon Rp. {}").format(list[x], barangyangdibeli, dis))
    else:
        print(("Harga {}\t Rp. {}\t Diskon Rp. {}").format(list[x], barangyangdibeli, 0))
